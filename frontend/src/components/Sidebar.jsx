  ...
  return (
    ...
    <div className='pb-5'>
     <div  className='flex justify-between items-center'>
       <img src={assets.pingmelogo} alt='logo' className='max-w-40' />
         <div className='relative py-2 group'>
           <img src={assets.menu_icon} alt='menu' className='max-h-5 cursor-pointer' />
            <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 test-gray-100 hidden group-hover:block'>
              <p onClick={()=>navigate('/profile')} cursor-pointer text-sm>Edit Profile</p>
